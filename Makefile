FILENAME = hashtable.exe
LIBNAME  = Obj/hashtable.a
...
ALLDEPS = $(HEADDIR)hashtable.h $(HEADDIR)hash.h
OBJECTS = example.o hashtable.o hash.o
OBJECTS_WITH_DIR = $(addprefix $(OBJDIR),$(OBJECTS))

LIB_OBJECTS = hashtable.o hash.o
